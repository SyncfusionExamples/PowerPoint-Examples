...
using Convert_PowerPoint_to_Image.SaveServices;

namespace Convert_PowerPoint_to_Image
{
    public partial class MainPage : ContentPage
    {
        ...
        private void ConvertPPTXtoImage(object sender, EventArgs e)
        {
            ...
            using (IPresentation pptxDoc = Presentation.Open(assembly.GetManifestResourceStream("Convert_PowerPoint_to_Image.Assets.Input.pptx")))
            {
